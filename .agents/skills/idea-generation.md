...
Systematic stock screening and investment idea sourcing to surface new long and short ideas.
...
**Key Risks:** What would make this wrong

**Next Steps:** Full model? Deep-dive diligence? Expert call?
...
## Command Workflow: /screen

Run a stock screen or generate investment ideas.

If criteria are provided, use them. Otherwise ask the user what they're looking for (long/short, sector, style, theme).

Deliver: shortlist of 5-10 ideas with one-page summaries, comparison table, prioritized list.
