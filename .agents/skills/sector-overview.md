...
description: Create comprehensive industry and sector landscape reports covering market dynamics, competitive positioning, key players, and thematic trends. Use for sector initiations, thematic research pieces, or internal knowledge building.
---

# Sector Overview

Create comprehensive industry and sector landscape reports with market sizing, competitive dynamics, and investment implications.
...
- Sector vs. broader market comparison
...
- Key debates (bull vs. bear arguments)
...
## Command Workflow: /sector

Create an industry landscape report covering market sizing, competitive dynamics, and investment implications.

If a sector is provided, use it. Otherwise ask the user which industry to cover.

Deliver: report with market overview, competitive landscape, company comparison table, valuation summary, and investment implications.
